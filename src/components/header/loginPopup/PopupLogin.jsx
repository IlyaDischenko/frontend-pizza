...
function UserPopup( {codeSend} ) {
    ...
    const firstFocus = React.useRef()
    const secondFocus = React.useRef()
                    ...
                    <div 
                        ...
                        <div className={s.divheader_active}>
                            ...
                            <div className={s.numberTitle}>
                                Отправили сообщение с кодом на <div><span>{popup.numberValue}</span> <span className={s.orange} onClick={setSendetFalse}>Изменить</span></div>
                            </div>
                        </div>
