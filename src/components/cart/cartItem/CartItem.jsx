...
import { addItem, clearItems, removeItem, itemPlus } from './../../../redux/slices/cartSlice';
    ...
    return (
        <div className={s.rootCartItem}>
            ...
            <div className={s.rightItems}>
                ...
                <div>{count}</div>
                    <button onClick={itemIncrement} className={s.secondButton}>
                ...
                <div className={s.priceAndRemove}>
                    ...
                    <div onClick={removeItem} className={s.removeItem}>
                        <button>
