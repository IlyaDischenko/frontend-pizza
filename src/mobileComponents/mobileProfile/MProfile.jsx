...
import s from './MProfile.module.scss'
        ...
        <div className={s.root_profile}>
            <div className={s.profile_wrapper}>
                ...
                <div className={s.email}>
                    <span>Почта</span>
                    <div>
                        <input type="email" className={checkChangeMail()} inputmode="email" onChange={(event) => dispatch(updaterEmailReducer(event.target.value))} value={userstate.updatedMail} />
